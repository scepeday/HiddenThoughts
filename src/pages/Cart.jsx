        ...
        {!items.length ? (
          ...
          <div className="cart-layout">
            <div className="cart-list">
              ...
              {items.map((item) => (
                <article className="cart-item" key={item.id}>
                  <ImageWithFallback src={getProductImageUrl(item)} alt={item.name} />
            ...
            <aside className="cart-summary">
              ...
              <p>Checkout stays outside the scope of this project. The cart remains functional, persistent, and API-safe.</p>
